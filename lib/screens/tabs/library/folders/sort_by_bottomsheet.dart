...
class FolderSortByBottomSheet extends StatefulWidget {
  ...
  @override
  State<FolderSortByBottomSheet> createState() =>
      _FolderSortByBottomSheetState();
}

class _FolderSortByBottomSheetState extends State<FolderSortByBottomSheet> {
      ...
      child: Column(
        ...
        children: [
          ...
          Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ...List.generate(folderSortByItems.length, (index) {
                var item = folderSortByItems[index];
                return ListTile(
                  dense: true,
