...
class CreateNewPlaylistBottomSheet extends StatefulWidget {
  ...
  @override
  _CreateNewPlaylistBottomSheetState createState() => _CreateNewPlaylistBottomSheetState();
}

class _CreateNewPlaylistBottomSheetState extends State<CreateNewPlaylistBottomSheet> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Texts('Create new playlist', fontSize: 18.sp, fontWeight: FontWeight.w500, fontFamily: AppFonts.inter),
          SizedBox(height: 30.h),
          Flexible(
            child: Padding(
              ...
              child: TextFieldWidget(
                ...
                hintStyle: TextStyle(fontSize: 13.sp, fontFamily: AppFonts.inter, fontWeight: FontWeight.w400),
