...
class _SongMenuScreenState extends State<SongMenuScreen> {
                              ...
                              if (songItem.title == localization.keepScreenOn) {
                                ...
                                if (widget.from == 'queue') {
                                  ...
                                  try {
                                    ...
                                    // Use the reorder method which handles both platforms correctly
                                    await musicService.reorderSongInQueue(
                                      songIndex,
                                      adjustedInsertIndex,
                                    );
                                    ...
                                    if (mounted) {
                                      final songToMove = musicService
                                          .songs[adjustedInsertIndex];
                                      showSnackBar(
                                        context,
                                        () {},
                                        message:
                                ...
                                if (widget.from == 'playlist') {
                                  ...
                                  if (musicService.songs.isEmpty) {
                                    ...
                                    if (existingIndex != -1 &&
                                      ...
                                      await musicService.playNextSingleSong(
                                        widget.currentSong!,
                                      );
                                ...
                                if (widget.from == 'playlist') {
                                  ...
                                  if (existingIndex == -1) {
                                    final status = await musicService
                                ...
                                if (widget.from == 'queue') {
                                  ...
                                  print(
                                    '  Queue size: ${musicService.songs.length}',
                                  );
                                  ...
                                  if (mutableSongs.isEmpty) {
                                    ...
                                    try {
                                      ...
                                      await musicService.player.seek(
                                        Duration.zero,
                                      );
                                    } catch (e) {
                                  ...
                                  try {
                                    if (isRemovingCurrent) {
                                      ...
                                      if (Platform.isAndroid) {
                                        final source =
                                            musicService.player.audioSource;
  ...
  //   }
  //
  //   // If maxHeight <= 1.0, treat it as a fraction of screen height.
  //   final heightFactor = widget.maxHeight <= 1.0 ? widget.maxHeight : null;
  //
  ...
  //                               context,
  //                               () {},
  //                               message: 'Unable to edit this song right now',
  //                               alertBannerLocation: AlertBannerLocation.bottom,
  //                             );
  //                           }
  //                           return;
  ...
  //                               if (mounted) {
  //                                 final songToMove =
  //                                     musicService.songs[adjustedInsertIndex];
  //                                 showSnackBar(
  //                                   context,
  //                                   () {},
  //                                   message:
  ...
  //                             if (existingIndex == -1) {
  //                               final status = await musicService
  //                                   .addSingleSongToQueue(widget.currentSong!);
  //                               if (status) {
  //                                 showSnackBar(
  //                                   context,
  //                                   () {},
  ...
  //                                   context,
  //                                   () {},
  //                                   message: 'Removed "${removedSong.title}"',
  //                                   alertBannerLocation:
  //                                       AlertBannerLocation.bottom,
  //                                 );
  //                               } else if (removeIndex < currentIndex) {
  ...
  //                                   print('  iOS: Updating list only');
  //                                   // ✅ iOS: Use dedicated method channel call for seamless removal
  //                                   await musicService.removeFromQueueAtIndex(
  //                                     removeIndex,
  //                                     newCurrentIndex,
  //                                   );
    ...
    showCommonConfirmationBottomSheet(
      ...
      onConfirm: (sheetContext) async {
        try {
          ...
          await musicService.removeDeletedSongFromQueue(
            widget.currentSong!.id!,
          );
