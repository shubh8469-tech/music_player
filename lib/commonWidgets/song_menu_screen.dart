                ...
                children: [
                  Expanded(
                    child: ListView.builder(
                      itemCount: widget.songMenuList.length + 1,
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final songItem = widget.songMenuList[index - 1];
                              ...
                              onTap: () async {
                                ...
                                if (songItem.title == localization.keepScreenOn) {
                                  ...
                                  if (widget.from == 'playlist') {
                                    ...
                                    if (existingIndex == -1) {
                                      final status = await musicService.addSingleSongToQueue(widget.currentSong!);
                                      if(status)
                                        {
