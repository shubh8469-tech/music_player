                                      ...
                                      : () async {
                                          try {
                                            ...
                                            if ((_bloc.state.currentIndex ?? -1) < 0) {
                                              ...
                                              _bloc.add(SetShufflePlaylistEvent(_songs.map((m) => m.toDomain()).toList(), autoPlay: false));
                                              _bloc.add(const EnsureShuffleOnReshuffleIndexEvent());
                                              await _bloc.player.currentIndexStream.firstWhere(
                                                (idx) => idx != null && idx != 0,
                                              );
                                              _bloc.add(const PlayEvent());
                                            }
                                            ...
                                            logS.log("Shuffle error in FolderDetailScreen: $e");
                                          }
                                        },
                                  child: Container(
                                          ...
                                          try {
                                            ...
                                            if (_bloc.state.isPlaying) {
                                              ...
                                              _bloc.add(SetPlaylistEvent(
                                                List<SongsModel>.from(_baseSongs).map((m) => m.toDomain()).toList(),
                                                startIndex: 0,
                                                autoPlay: true,
                                              ));
                                            }
                                          } catch (e) {
                                            logS.log("Play error in FolderDetailScreen: $e");
                                          }
                                        },
                                  child: Container(
                                    height: 40.h,
