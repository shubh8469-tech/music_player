...
import 'package:music_app/features/music_player/data/services/diagnose_equalizer.dart';
...
class EqualizerProvider extends ChangeNotifier {
  EqualizerProvider({required MusicPlayerBloc bloc})
      : _eqService = bloc.equalizerService as UnifiedEqualizerService,
        _player = bloc.player {
    _init();
  }
  ...
  Future<void> _runDiagnostic() async {
    ...
    if (Platform.isAndroid) {
      final eq = _eqService.androidEqualizer;
      if (_player != null && eq != null) {
        await EqualizerDiagnostic.checkEqualizerSetup(_player, eq);
      }
    }
  }
