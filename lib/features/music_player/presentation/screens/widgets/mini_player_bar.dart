    ...
    return BlocBuilder<MusicPlayerBloc, MusicPlayerState>(
      ...
      builder: (context, state) {
        ...
        return GestureDetector(
          onTap: () {
            context.push('/dashboard/playing', extra: PlayingSongArgs(songs: state.songs));
          },
          child: Container(
                      ...
                      Expanded(
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () => bloc.add(const NextEvent()),
...
class _PlayPauseButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (state.isPlaying) {
      return GestureDetector(
        onTap: () => bloc.add(const PauseEvent()),
    ...
    return GestureDetector(
      onTap: () => bloc.add(const PlayEvent()),
